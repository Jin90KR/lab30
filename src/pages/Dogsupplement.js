...
class Dogsupplement extends React.Component {

    render() {
        console.log(this.props)
        return (
            <div className="main-body">
                <p className="main-text">강아지 영양제</p>
                <div className="bestsellers">
                    {
                        this.props.items.map(item => {
                            if (item.category === "dogsupplement") {
                                return (
...
export default connect(mapStateToProps, null)(Dogsupplement);